...
def get_data_loaders(batch_size, img_size, device):
    ...
    train_dataset = (
        wds.WebDataset("data/imagenet100/imagenet100-320_shards/train_2000/train-{000000..000064}.tar", shardshuffle=10)
    ...
    val_dataset = (
        wds.WebDataset("data/imagenet100/imagenet100-320_shards/val_2000/val-{000000..000002}.tar", shardshuffle=False)
        .decode("pil")
        .to_tuple("jpg", "cls")
        .map_tuple(val_transform, lambda x: int(x))
    )

    train_loader = DataLoader(train_dataset, batch_size=batch_size, num_workers=6, pin_memory=True)
