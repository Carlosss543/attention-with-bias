...
# --- load model ---
model = vit_custom(num_classes=params.num_classes, image_size=params.crop_size, use_bias=params.use_bias, bias_threshold=params.bias_threshold, bias_topk=params.bias_topk, bias_score_threshold=params.bias_score_threshold, bias_only=params.bias_only).to(device)
